...
<div class="container">
    ...
    <div class="big-terminal">
        ...
        <div class="what-is-blockchain">
            ...
            <p><strong>Блокчейн</strong>strong> — это распределённая база данных, где информация хранится в виде непрерывной цепочки блоков. Каждый блок содержит набор записей (транзакций) и криптографическую ссылку на предыдущий блок.</p>
            <p>🔐 <strong>Главная задача блокчейна</strong> — обеспечить доверие без посредников. Благодаря децентрализации и неизменяемости, блокчейн позволяет фиксировать любые ценности (деньги, контракты, активы) так, что их нельзя подделать или удалить. Вы можете проверить всю историю, но не можете изменить прошлое.</p>
            <p>🌐 Блокчейн лежит в основе криптовалют (биткоин, эфир), смарт-контрактов, цифровых удостоверений, логистики и многих других сфер, где важна прозрачность и защита от мошенничества.</p>
        </div>
